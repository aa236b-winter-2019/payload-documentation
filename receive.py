...
# Title: receive
# Generated: Tue Feb 26 12:48:19 2019
##################################################
...
class receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 90.1e6
        ...
        self.osmosdr_source_0.set_sample_rate(8000000)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate, 8000, 2000, firdes.WIN_HAMMING, 6.76))
        ...
        self._freq_range = Range(0, 110e6, 1, 5000, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, "/home/aa274/payload-documentation/test.bin", False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_argmax_xx_0 = blocks.argmax_fs(fft_size)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(8000000, analog.GR_COS_WAVE, -1750000, 1, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_nbfm_rx_1, 0), (self.qtgui_time_sink_x_1_0, 0))    
        ...
        self.connect((self.low_pass_filter_0, 0), (self.analog_nbfm_rx_1, 0))    
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center_freq, 4000000)
